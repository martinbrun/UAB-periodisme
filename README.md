...
**EN**: This repository contains all course material for practical classes of Economic Theory and Structure (group B: surname starting from G to P) of the Journalism grade in the Universitat Autònoma de Barcelona. Content is entirely in Spanish.

**ES**: Este repositorio contiene todos los materiales para las clases prácticas del curso Teoría y Estructura Económica (grupo B: apellidos empezando con G hasta P) del Grado de Periodismo en la Universitat Autònoma de Barcelona.

**CA**: Aquest repositori conté tots els materials per a les classes pràctiques de el curs Teoria i Estructura Econòmica (grup B: cognoms començant amb G fins P) de l'Grau de Periodisme a la Universitat Autònoma de Barcelona. Els continguts estan enterament en Castellà.
